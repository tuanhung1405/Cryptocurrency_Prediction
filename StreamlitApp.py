...
st.set_page_config(page_title='Crypto-Currency Price Prediction',page_icon="📶",layout="wide")
...
st.markdown("https://github.com/tuanhung1405/Cryptocurrency_Prediction.git", unsafe_allow_html=True)
st.markdown("Presentation report: ")
st.markdown("https://drive.google.com/file/d/1hMAIYuiOCLQako7ToSGypWbhN7lH0nh9/view?usp=sharing", unsafe_allow_html=True)
st.write('---')
####################################################################
